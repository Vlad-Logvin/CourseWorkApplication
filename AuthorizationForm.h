...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(357, 52);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Enter the System";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(21, 111);
			...
			this->textBox1->Location = System::Drawing::Point(21, 139);
			this->textBox1->MaxLength = 30;
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(331, 39);
			this->textBox1->TabIndex = 3;
			this->textBox1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &AuthorizationForm::textBox1_KeyPress);
			this->textBox1->MouseHover += gcnew System::EventHandler(this, &AuthorizationForm::textBox1_MouseHover);
			// 
			// label3
			// 
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox2->Location = System::Drawing::Point(21, 242);
			this->textBox2->MaxLength = 30;
			this->textBox2->Multiline = true;
			this->textBox2->Name = L"textBox2";
			this->textBox2->PasswordChar = '*';
			this->textBox2->Size = System::Drawing::Size(331, 39);
			this->textBox2->TabIndex = 5;
			this->textBox2->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &AuthorizationForm::textBox1_KeyPress);
			this->textBox2->MouseHover += gcnew System::EventHandler(this, &AuthorizationForm::textBox1_MouseHover);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(21, 346);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(331, 57);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(21, 409);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(331, 57);
			this->button2->TabIndex = 7;
			this->button2->Text = L"Register";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &AuthorizationForm::button2_Click);
			// 
			// menuStrip1
			// 
			...
			// 
			this->applicationToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->exitToolStripMenuItem });
			...
			this->exitToolStripMenuItem->Click += gcnew System::EventHandler(this, &AuthorizationForm::exitToolStripMenuItem_Click);
			// 
			// AuthorizationForm
			// 
			...
			this->ClientSize = System::Drawing::Size(378, 478);
